...
#define TYPE_NOVA_A9_MACHINE   MACHINE_TYPE_NAME("nova-a9")
                                  ...
                                  qemu_irq *pic)
{
    ...
    memory_region_add_subregion(sysmem, 0x70000000, ram);
...
static void nova_a9_instance_init(Object *obj)
{
    VexpressMachineState *vms = NOVA_MACHINE(obj);
...
static void nova_class_init(ObjectClass *oc, void *data)
{
    ...
    mc->desc = "Nova ARM Versatile Express";
    mc->init = nova_common_init;
    mc->max_cpus = 4;
    mc->ignore_memory_transaction_failures = true;
}

static void nova_a9_class_init(ObjectClass *oc, void *data)
{
    MachineClass *mc = MACHINE_CLASS(oc);
    VexpressMachineClass *vmc = NOVA_MACHINE_CLASS(oc);

    mc->desc = "Nova ARM Versatile Express for Cortex-A9";
...
static const TypeInfo nova_a9_info = {
    .name = TYPE_NOVA_A9_MACHINE,
    .parent = TYPE_NOVA_MACHINE,
    .class_init = nova_a9_class_init,
    .instance_init = nova_a9_instance_init,
};

static void nova_machine_init(void)
{
    type_register_static(&nova_info);
    type_register_static(&nova_a9_info);
}
